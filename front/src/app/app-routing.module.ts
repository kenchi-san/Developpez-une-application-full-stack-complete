...
import {IntraPageComponent} from "./pages/intra-page/intra-page.component";  // Assurez-vous que ce fichier existe
...
const routes: Routes = [
  ...
  { path: 'test', component: IntraPageComponent }, // à réactiver quand prêt
  {
    path: 'login',
